...
describe('Users home page view', () => {
  ...
  it('Should update the name input when information is entered', () => {
    cy.get('[data-cy="new-trick-name"]').type('Flopagus 9000')
    cy.get('[data-cy="new-trick-name"]').should.have.value('Flopagus 9000')
  })

  it('Should update the stance input information is entered', () => {
    cy.get('[data-cy="new-trick-name"]').select(0)
    cy.get('[data-cy="new-trick-name"]').should.have.value('regular')
  })
})